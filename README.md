...
df=pd.read_csv('/content/weather.csv',encoding='utf-8')
...
```
## Output:
![image](https://github.com/user-attachments/assets/9a548264-7230-4960-a9cb-46f42f2ffc36)

![image](https://github.com/user-attachments/assets/28c76799-f6f3-4efe-8301-d5118384de7d)
